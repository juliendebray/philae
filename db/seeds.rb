...
require 'json'
require 'rest_client'
url_json = 'https://spreadsheets.google.com/feeds/list/1dgJpdDW8j7mt_R9gzFooSEqrBjj0lspi5McC3IMJJYE/od6/public/values?alt=json'
...
data_hash['feed']['entry'].each do |exp_data|
  ...
  gen_url = "http://philae-floju.s3.amazonaws.com/photos_perou/"
